...
<body>
        ...
        <div class="container">
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="IT"/>IT<div style="margin-left:80px"><input type="radio" name="branch" value="CS"/>CS<input type="radio" name="branch" value="EXTC"/>EXTC</div>
            </div>   
